...
RubyUnits::Unit.define('point') do |point|
  point.definition = RubyUnits::Unit('1/72 ft')
  point.aliases    = %w{point points}
end

RubyUnits::Unit.define('pica') do |pica|
  pica.definition = RubyUnits::Unit('12 point')
  pica.aliases    = %w{P pica picas}
end

RubyUnits::Unit.define('dot') do |dot|
  dot.definition  = RubyUnits::Unit('1 each')
  dot.aliases     = %w{dot dots}
  dot.kind        = :counting
end

RubyUnits::Unit.define('pixel') do |pixel|
  pixel.definition  = RubyUnits::Unit('1 each')
  pixel.aliases     = %w{px pixel pixels}
  pixel.kind        = :counting
end

RubyUnits::Unit.define('ppi') do |ppi|
  ppi.definition  = RubyUnits::Unit('1 pixel/inch')
end

RubyUnits::Unit.define('dpi') do |dpi|
  dpi.definition  = RubyUnits::Unit('1 dot/inch')
end

# Mass

avagadro_constant = RubyUnits::Unit('6.02214129e23 1/mol')

RubyUnits::Unit.define('AMU') do |amu|
  amu.definition = RubyUnits::Unit('12 kg/mol') / (12 * avagadro_constant)
  amu.aliases    = %w{u AMU amu}
end

RubyUnits::Unit.define('dalton') do |dalton|
  dalton.definition = RubyUnits::Unit('1 amu')
  dalton.aliases    = %w{Da dalton daltons}
end

standard_gravitation = RubyUnits::Unit('9.80665 m/s^2')

RubyUnits::Unit.define('metric-ton') do |mton|
  mton.definition = RubyUnits::Unit('1000 kg')
...
RubyUnits::Unit.define('cfm') do |cfm|
  cfm.definition = RubyUnits::Unit('1 ft^3/minute')
...
RubyUnits::Unit.define('kph') do |kph|
  kph.definition  = RubyUnits::Unit('1 kilometer/hour')
end

RubyUnits::Unit.define('mph') do |mph|
  mph.definition  = RubyUnits::Unit('1 mile/hour')
end

RubyUnits::Unit.define('fps') do |fps|
  fps.definition  = RubyUnits::Unit('1 foot/second')
end

RubyUnits::Unit.define('knot') do |knot|
  knot.definition   = RubyUnits::Unit('1 nmi/hour')
...
RubyUnits::Unit.define('gee') do |gee|
  ...
  gee.definition    = RubyUnits::Unit(Rational(196133,20000), 'm/s^2') # equivalent to 9.80665 m/s^2
...
RubyUnits::Unit.define('newton') do |newton|
  newton.definition = RubyUnits::Unit('1 kg*m/s^2')
  newton.aliases    = %w{N newton newtons}
end

RubyUnits::Unit.define('dyne') do |dyne|
  dyne.definition = RubyUnits::Unit('1/100000 N')
  dyne.aliases    = %w{dyn dyne}
end

RubyUnits::Unit.define('pound-force') do |lbf|
  lbf.definition  = RubyUnits::Unit('1 lb') * RubyUnits::Unit('1 gee')
  lbf.aliases     = %w{lbf pound-force}
end

RubyUnits::Unit.define('poundal') do |poundal|
  poundal.definition  = RubyUnits::Unit('1 lb') * RubyUnits::Unit('1 ft/s^2')
...
RubyUnits::Unit.define('AU') do |au|
  au.definition = RubyUnits::Unit('149597870700 m')
  au.aliases    = %w{AU astronomical-unit}
end

RubyUnits::Unit.define('redshift') do |red|
  red.definition = RubyUnits::Unit('1.302773e26 m')
...
RubyUnits::Unit.define('slug') do |slug|
  slug.definition = RubyUnits::Unit('1 lbf*s^2/ft')
...
RubyUnits::Unit.define('pascal') do |pascal|
  pascal.definition = RubyUnits::Unit('1 kg/m*s^2')
  pascal.aliases    = %w{Pa pascal pascals}
end

RubyUnits::Unit.define('bar') do |bar|
  bar.definition  = RubyUnits::Unit('100 kPa')
  bar.aliases     = %w{bar bars}
end

RubyUnits::Unit.define('atm') do |atm|
  atm.definition  = RubyUnits::Unit('101325 Pa')
  atm.aliases     = %w{atm ATM atmosphere atmospheres}
end

RubyUnits::Unit.define('mmHg') do |mmhg|
  density_of_mercury  = RubyUnits::Unit('7653360911758079/562949953421312 g/cm^3') # 13.5951 g/cm^3 at 0 tempC
  mmhg.definition     = RubyUnits::Unit('1 mm') * RubyUnits::Unit('1 gee') * density_of_mercury
end

RubyUnits::Unit.define('inHg') do |inhg|
  density_of_mercury = RubyUnits::Unit('7653360911758079/562949953421312 g/cm^3') # 13.5951 g/cm^3 at 0 tempC
  inhg.definition    = RubyUnits::Unit('1 in') * RubyUnits::Unit('1 gee') * density_of_mercury
end

RubyUnits::Unit.define('torr') do |torr|
  torr.definition = RubyUnits::Unit('1/760 atm')
  torr.aliases    = %w{Torr torr}
end

RubyUnits::Unit.define('psi') do |psi|
  psi.definition  = RubyUnits::Unit('1 lbf/in^2')
end

RubyUnits::Unit.define('cmh2o') do |cmh2o|
  density_of_water  = RubyUnits::Unit('1 g/cm^3') # at 4 tempC
  cmh2o.definition  = RubyUnits::Unit('1 cm') * RubyUnits::Unit('1 gee') * density_of_water
  cmh2o.aliases     = %w{cmH2O cmh2o cmAq}
end

RubyUnits::Unit.define('inh2o') do |inh2o|
  density_of_water  = RubyUnits::Unit('1 g/cm^3') # at 4 tempC
  inh2o.definition  = RubyUnits::Unit('1 in') * RubyUnits::Unit('1 gee') * density_of_water
...
RubyUnits::Unit.define('poise') do |poise|
  poise.definition  = RubyUnits::Unit('dPa*s')
  poise.aliases     = %w{P poise}
end

RubyUnits::Unit.define('stokes') do |stokes|
  stokes.definition = RubyUnits::Unit('1 cm^2/s')
...
RubyUnits::Unit.define('joule') do |joule|
  joule.definition  = RubyUnits::Unit('1 N*m')
  joule.aliases     = %w{J joule joules}
end

RubyUnits::Unit.define('erg') do |erg|
  erg.definition  = RubyUnits::Unit('1 g*cm^2/s^2')
